                    ...
                    >
                      <div className="flex items-center gap-4 flex-1 min-w-0">
                        ...
                        <div className="relative flex-shrink-0">
                          <img
                            src={
                              imageErrors[order.items[0]?.pizza.id]
                                ? FALLBACK_IMAGE
                                : order.items[0]?.pizza.imageUrl
                            }
                            alt=""
                      ...
                      <div className="flex items-center gap-4 flex-shrink-0">
                        ...
                        <div
                          className={`p-1 rounded-full bg-gray-100 dark:bg-gray-800 transition-transform duration-200 ${isExpanded ? 'rotate-180' : ''}`}
                        >
                        ...
                        <div className="space-y-3 mb-4">
                          {order.items.map((item) => (
                            ...
                            >
                              <img
                                src={
                                  imageErrors[item.pizza.id] ? FALLBACK_IMAGE : item.pizza.imageUrl
                                }
                                alt={item.pizza.name}
                                className="w-12 h-12 rounded-lg object-cover"
                                onError={() =>
                                  setImageErrors((prev) => ({ ...prev, [item.pizza.id]: true }))
                                }
                              />
                              <div className="flex-1 min-w-0">
