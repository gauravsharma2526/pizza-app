    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-lg w-full text-center">
        ...
        <div className="relative mb-8">
          ...
          <span className="absolute top-0 right-8 text-4xl animate-bounce text-orange-400 dark:text-orange-500" style={{ animationDelay: '0.1s' }}>?</span>
          <span className="absolute top-4 left-8 text-3xl animate-bounce text-amber-400 dark:text-amber-500" style={{ animationDelay: '0.3s' }}>?</span>
          <span className="absolute bottom-8 right-4 text-2xl animate-bounce text-yellow-400 dark:text-yellow-500" style={{ animationDelay: '0.5s' }}>?</span>
        </div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">
          Looks like someone already ate this page! Don't worry, we have plenty more delicious options for you.
        </p>
