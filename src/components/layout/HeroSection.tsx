  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className={`absolute top-1/3 right-1/4 w-48 h-48 rounded-full blur-2xl opacity-20 ${
      ...
      <div className="relative page-container py-12 md:py-16 lg:py-20">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="inline-flex items-center gap-3 mb-5">
            <span
              className={`w-10 h-[2px] rounded-full ${isPrimary ? 'bg-secondary-400' : 'bg-primary-400'}`}
            />
